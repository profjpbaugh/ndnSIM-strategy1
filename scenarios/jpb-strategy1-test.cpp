...
#include "umd/JPBPolicyToFile.hpp"
...
namespace ns3 {
  ...
  main(int argc, char* argv[])
  {
     ...
     ndn::StrategyChoiceHelper::Install<nfd::fw::PopularityStrategy>(nodes.Get(2),
                                                                    ndn::Name("/prefix")) ;
  ...
  //for a node - the router (node 1)
     ...
     unique_ptr<JPBPolicyToFile> policy =  ndn::make_unique<JPBPolicyToFile>(); 

     policy->setLimit(10);  //should be same as Cs::setLimit
